document.addEventListener('DOMContentLoaded', function() {
    // This handles chat widget functionality inside the iframe
    ...
    // Handle chat session and resizing of the chat widget itself (but not the iframe)
    ...
    var isLarge = false;  // Track if the chat container is large
    ...
    // Handle resizing of the chat container (not the iframe)
